...
(function(){
  ...
  document.addEventListener('submit',async e=>{
    ...
    try{
      ...
      const rem=String(document.getElementById('hsTrailer')?.value||'').trim();if(u.esTracto&&!rem)throw new Error('La Caja es obligatoria cuando la unidad es Tracto-camión. Selecciona una caja.');if(u.esTracto&&!boxes().some(x=>norm(x.numero)===norm(rem)))throw new Error('Selecciona una caja válida del catálogo.');
