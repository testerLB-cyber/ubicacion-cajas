...
(function(){
  ...
  app.version='profesional-modular-v15-rentas-tipo-prorrateo';
  ...
  function loadOptionalModules(){if(loaded||!window.CC_AUTH_READY||!window.gmSupabase)return false;loaded=true;addScript('assets/js/modules/activity-log.js?v=20260914-safe-2','data-cc-activity-log');addScript('assets/js/modules/inventario-tipo-unidad-general.js?v=20260914-inventory-final-3','data-cc-unit-type-canonical');addScript('assets/js/modules/inventario-estabilidad-tabla.js?v=20260914-table-stable-1','data-cc-inventory-table-stability');addScript('assets/js/modules/renta-tarifas-tipo-v1.js?v=20260914-rent-type-1','data-cc-rent-type-rates');if(!document.querySelector('script[data-cc-commissions-direct]'))addScript('assets/js/modules/commissions-liquidations.js?v=20260914-safe-2','data-cc-commissions');return true;}
