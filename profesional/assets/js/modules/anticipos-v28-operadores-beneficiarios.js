...
(function(){
  ...
  function renderConfigPanel(){
    ...
    const legacy=document.getElementById('ccAntCatalogV12');if(legacy){[...legacy.querySelectorAll(':scope > div')].forEach(x=>{if(/Configuración por destino/i.test(x.querySelector('.cc-toolbar strong')?.textContent||''))x.style.display='none'})}
  }
