...
(function(){
  ...
  app.version='profesional-modular-v46-dot-operador-borrado';
  ...
  function loadOptionalModules(){
    ...
    addScript('assets/js/modules/dot-operador-borrado-v1.js?v=20260914-dot-op-delete-1','data-cc-dot-op-delete');
