...
(function(){
  ...
  function installStyles(){
    ...
    const st=document.createElement('style');st.id='hs104-style';st.textContent=`
      ...
      #ccPanelHojasServicio .hs-manual-photo-box{grid-column:1/-1;margin-top:4px;padding:11px;border:1px dashed #cbd5e1;border-radius:10px;background:#f8fafc}
      #ccPanelHojasServicio .hs-manual-photo-box label{display:block;font-weight:800;color:#334155;margin-bottom:7px}
      #ccPanelHojasServicio .hs-photo-methods{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;width:100%}
      #ccPanelHojasServicio .hs-photo-methods .cc-btn{width:100%;min-width:0;min-height:42px;white-space:normal;line-height:1.2}
