...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  // Carga secuencial: módulo principal -> buscador -> precaptura -> ver todos -> modo lista -> foto manual/PDF.
  ccLoadScriptOnce('assets/js/modules/service-sheets-v104.js?v=hs-v104-fix1','data-hs-main','1')
    ...
    .then(()=>ccLoadScriptOnce('assets/js/modules/service-sheets-manual-photo-pdf.js?v=hs-manual-photo-pdf-v1','data-hs-manual-photo-pdf','1'))
