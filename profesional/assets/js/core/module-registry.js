...
(function(){
  ...
  app.version='profesional-modular-v50-anticipos-sin-tipo-unidad-propio';
  ...
  function loadOptionalModules(){
    ...
    addScript('assets/js/modules/configuracion-qr-pdf-v1.js?v=20260914-qr-pdf-large-2','data-cc-config-qr-pdf');
    ...
    addScript('assets/js/modules/dot-operador-borrado-v1.js?v=20260914-dot-required-3','data-cc-dot-op-delete');
    addScript('assets/js/modules/catalog-autocomplete-global-v1.js?v=20260914-global-catalog-autocomplete-1','data-cc-global-catalog-autocomplete');
    ...
    addScript('assets/js/modules/anticipos-sin-tipo-unidad-propio-v1.js?v=20260914-ant-no-own-unit-type-1','data-cc-ant-no-own-unit-type');
