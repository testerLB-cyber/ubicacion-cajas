...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    load('assets/js/modules/service-sheets-v104.js?v=correcta1','data-correct-hs-main')
      ...
      .then(()=>load('assets/js/modules/service-sheets-manual-photo-pdf.js?v=correcta1','data-correct-hs-photo'))
