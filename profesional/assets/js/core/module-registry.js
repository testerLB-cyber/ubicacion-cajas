...
(function(){
  ...
  app.version='profesional-modular-v57-anticipos-config-destino-fix';
  app.cacheVersion='20260914-v57-ant-dest-save-2';
  ...
  function loadOptionalModules(){
    ...
    addScript('assets/js/modules/anticipos-destino-tipo-unidad-general-v1.js?v=20260914-v57-ant-dest-save-2','data-cc-ant-dest-unit-general');
    addScript('assets/js/modules/anticipos-destino-nueva-config-v1.js?v=20260914-v57-ant-dest-save-2','data-cc-ant-new-dest-config');
    addScript('assets/js/modules/anticipos-config-destino-guardado-atomico-v1.js?v=20260914-v57-ant-dest-save-2','data-cc-ant-dest-save-atomic');
