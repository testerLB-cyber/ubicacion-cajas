...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    load('assets/js/modules/service-sheets-v104.js?v=20260924-benef-web2','data-correct-hs-main')
      ...
      .then(()=>load('assets/js/modules/service-sheets-unit-trailer-v1.js?v=20260924-benef-op1','data-hs-unit-trailer-v1'))
