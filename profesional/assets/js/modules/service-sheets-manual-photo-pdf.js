...
(function(){
  ...
  function ensureStyles(){
    ...
    const st=document.createElement('style');st.id='hs-manual-photo-pdf-style-v2';st.textContent=`
      ...
      @media(max-width:640px){.hs-photo-methods .cc-btn{font-size:12px;line-height:1.2}}
