...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    load('assets/js/modules/service-sheets-v104.js?v=qr-core-20260923','data-correct-hs-main')
      ...
      .then(()=>load('assets/js/modules/service-sheets-list-mode.js?v=qr-core-20260923','data-correct-hs-list'))
      .then(()=>load('assets/js/modules/service-sheets-manual-photo-pdf.js?v=qr-core-20260923','data-correct-hs-photo'))
