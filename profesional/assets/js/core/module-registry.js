...
(function(){
  ...
  app.version='profesional-modular-v64-anticipos-canonical';
  app.cacheVersion='20260914-v64-ant-canonical-1';
  ...
  let loaded=false;
  function addScript(src,attr){if(document.querySelector('script['+attr+']'))return;const s=document.createElement('script');s.src=src;s.async=false;s.setAttribute(attr,'1');s.onerror=()=>console.error('No se pudo cargar módulo opcional:',src);document.head.appendChild(s);}
  function loadOptionalModules(){
    if(loaded||!window.CC_AUTH_READY||!window.gmSupabase)return false;loaded=true;
    ...
    /* Anticipos: una sola UI de catálogos y una sola lógica Destino + Tipo general. */
    addScript('assets/js/modules/anticipos-catalogos-canonical-v1.js?v=20260914-v64-1','data-cc-ant-catalog-canonical');
    addScript('assets/js/modules/anticipos-destino-tipo-unidad-general-v1.js?v=20260914-v64-1','data-cc-ant-dest-unit-general');
