...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    load('assets/js/modules/service-sheets-v104.js?v=20260914-any-custody-1','data-correct-hs-main')
      ...
      .then(()=>load('assets/js/modules/service-sheets-list-mode.js?v=qr-en-editar-20260922d','data-correct-hs-list'))
      .then(()=>load('assets/js/modules/service-sheets-manual-photo-pdf.js?v=qr-en-editar-20260922d','data-correct-hs-photo'))
