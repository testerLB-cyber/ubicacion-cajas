...
(function(){
  ...
  app.version='profesional-modular-v12-inventory-clean';
  ...
  function loadOptionalModules(){if(loaded||!window.CC_AUTH_READY||!window.gmSupabase)return false;loaded=true;addScript('assets/js/modules/activity-log.js?v=20260914-safe-2','data-cc-activity-log');addScript('assets/js/modules/inventario-tipo-unidad-general.js?v=20260914-inventory-clean-2','data-cc-unit-type-canonical');if(!document.querySelector('script[data-cc-commissions-direct]'))addScript('assets/js/modules/commissions-liquidations.js?v=20260914-safe-2','data-cc-commissions');return true;}
