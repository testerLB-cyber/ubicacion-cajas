...
(function(){
  ...
  app.version='profesional-modular-v44-correo-estable';
  ...
  function loadOptionalModules(){
    ...
    addScript('assets/js/modules/correo-validacion-v2.js?v=20260914-mail-rebuild-2','data-cc-mail-validate-v2');
