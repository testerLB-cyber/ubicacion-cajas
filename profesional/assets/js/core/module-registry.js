...
(function(){
  ...
  app.version='profesional-modular-v43-correo-reconstruido';
  ...
  function loadOptionalModules(){
    ...
    addScript('assets/js/modules/correo-validacion-v2.js?v=20260914-mail-rebuild-1','data-cc-mail-validate-v2');
